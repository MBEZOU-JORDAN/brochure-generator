...
async def search(q: str = Query(..., min_length=2, description="Nom de l'entreprise à rechercher")):
    """
    ...
    try:
        ...
        raise HTTPException(status_code=503, detail=f"La requête est vide. Erreure: {str(e)}")
